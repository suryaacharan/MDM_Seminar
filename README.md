...
```sql
Drop DATAVERSE MDM25;
CREATE DATAVERSE MDM25 IF NOT EXISTS;
USE MDM25;
...
## 🧭 Add Geometry Field to Businesses
...
## ⭐ Avg Stars by Category near a Tourist Line
...
## 🚦 Roads with Most 5-Star Businesses Nearby
...
## 🌐 GeoJSON Output of Top Roads by Density
...
## 🤝 Jaccard Similarity between Reviews and Business Names
...
## 📝 Review Texts for Matched Businesses (5-star only)
